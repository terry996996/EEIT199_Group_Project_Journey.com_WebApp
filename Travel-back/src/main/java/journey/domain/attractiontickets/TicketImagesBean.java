...
public class TicketImagesBean {
    ...
    public TicketImagesBean() {
    }

    public TicketImagesBean(Integer imageId, AttractionTicketsBean ticket, String imageUrl, String imageType,
            String altText,
            Integer sortOrder) {
