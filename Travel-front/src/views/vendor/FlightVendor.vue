...
<template>
  <div class="vendor-info-section">
        ...
        <div class="vendor-header-content">
          <div class="vendor-info">
            ...
            <div class="vendor-details">
              <h1 class="vendor-title">機票商家管理中心</h1>
    ...
    <div class="container">
      <VendorUpload vendorType="flight" :vendorId="vendorId" />
    </div>
  </div>
</template>
...
<script setup>
  ...
  onMounted(() => {
    ...
    if (!isLoggedIn || vendorType !== 'flight') {
      router.push('/vendor/login');
      return;
    }
    ...
    // 設置 vendor_id
    if (storedVendorId) {
      vendorId.value = parseInt(storedVendorId);
      console.log('載入商家 ID:', vendorId.value);
    } else {
      console.error('找不到商家 ID');
      router.push('/vendor/login');
      return;
    }
